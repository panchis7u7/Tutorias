...
namespace Sistema_Gestor_de_Tutorias
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IPagina_Consultas_Bindings
        {
            ...
            {
                if (lineNumber == 84 && columnNumber == 50)
                {
                    isobj14TextDisabled = true;
                }
                else if (lineNumber == 85 && columnNumber == 57)
                {
                    isobj15TextDisabled = true;
                }
                else if (lineNumber == 86 && columnNumber == 54)
                {
            ...
            IPagina_Consultas_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 47 && columnNumber == 150)
                {
                    isobj24TextDisabled = true;
                }
                else if (lineNumber == 48 && columnNumber == 144)
                {
                    isobj25TextDisabled = true;
                }
                else if (lineNumber == 49 && columnNumber == 136)
                {
