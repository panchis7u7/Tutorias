#pragma checksum "E:\Proyectos\C#\Tutorias C#\Sistema Gestor de Tutorias\Pagina_Consultas.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "4D135FFB48A115234F20AC97FB15AAC276C34CD8974EA7C7BEBB542ACBC5FE4B"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Sistema_Gestor_de_Tutorias
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IPagina_Consultas_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 44 && columnNumber == 136)
                {
                    isobj25TextDisabled = true;
                }
                else if (lineNumber == 45 && columnNumber == 130)
                {
                    isobj26TextDisabled = true;
                }
                else if (lineNumber == 46 && columnNumber == 136)
                {
                    isobj27TextDisabled = true;
                }
                else if (lineNumber == 47 && columnNumber == 134)
                {
                    isobj28TextDisabled = true;
                }
                else if (lineNumber == 48 && columnNumber == 150)
                {
                ...
                else if (lineNumber == 50 && columnNumber == 136)
                {
            ...
            private void UpdateTwoWay_29_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        ...
                        {
                            this.dataRoot.grupo_seleccionado.DateLine = this.obj29.Text;
                        }
                    }
                }
            }
